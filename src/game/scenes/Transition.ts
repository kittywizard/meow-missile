export default class Transition extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(this.center_width, this.center_height - 50, "minogram", messages[this.number - 1], 70).setOrigin(0.5).setTintFill(0x000000);

        this.add.bitmapText(this.center_width, this.center_height + 50, "minogram", "Player 1", 50).setOrigin(0.5).setTintFill(0x000000);
